# Digital_Twin
Trying to build a working Digital twin of Andrej Karpathy , which uses Gemini 2.5 flash, FAISS vector database which has vector embeddings of his bolgs ,texts , speeches , ideas and transcripts from his youtube lectures .
It has a dual input and output ie both via text and via voice ( sadly coudldnt recreate his voice)
